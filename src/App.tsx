...
import PublicAgreement from './PublicAgreement'
...
export default function App() {
  ...
  if (currentPath === '/public-agreement') return <PublicAgreement />
